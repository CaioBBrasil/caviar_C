...
class AirSimTools:
    ...
    def has_uav_arrived(self, x, y, z):
        uav_pose = self.airsim_getpose()
        if (
    ...
    def set_orientation(self, roll=0, pitch=0, yaw=0):  # , client, uav_id
        """
        Sets the orientation of the drone to the specified roll, pitch, and yaw angles.
        """
        orientation = airsim.to_quaternion(roll, pitch, yaw)
